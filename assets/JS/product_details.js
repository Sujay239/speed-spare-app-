document.addEventListener('DOMContentLoaded', () => {
    ...
    function findProduct(id) {
        ...
        const dataSources = [
            dealsData, trendingData, popularData,
            recommendedData, recentlyViewedData, allProductsData
        ];
    ...
    if (product) {
                ...
                <div class="product-hero">
                    <div class="hero-controls">
                        ...
                        <div class="hero-right-controls">
                            ...
                            <button class="control-btn"><i class="fa-solid fa-share-nodes"></i></button>
                        </div>
                    </div>
        ...
        if (root) root.innerHTML = `<div style="padding: 50px; text-align: center;"><h2>Product Not Found</h2><a href="index.php">Go Back</a></div>`;
    }
    ...
    function renderRelatedProducts(currentId) {
        ...
        if (typeof allProductsData !== 'undefined') {
            const related = allProductsData.filter(p => p.id !== currentId).slice(0, 5);
